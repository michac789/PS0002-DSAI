...
lab1 <- read.fwf("assets/lab1fixed.txt", col.names = var_lab1fixed,
    width = c(3, 1, 3, 2, 1))
...
# d. Remove record related to subject 211 from the data to new df 'lab1remo'
attach(lab1merge)
...
# f. Who is the second tallest female in this group?
# what are her height, weight, test score?
